...
namespace SourceCode.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IUserService userService, IOrderService orderService, IOrderDetailService orderDetailService, IProductService productService, IRatingService ratingService, ICartService cartService, IUsersSpinService usersSpinService)
        {
